...
PACKAGE ?= helm-external-secrets
XRD_DIR := apis/externalsecrets
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/externalsecrets/standard.yaml
...
EXAMPLES := \
    examples/externalsecrets/minimal.yaml:: \
    examples/externalsecrets/standard.yaml::
...
render\:%:
	@example="examples/externalsecrets/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
